...
export function UrinaryIncontinenceStudiesSupplementary() {
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-start lg:gap-16">
            <div>
              <div className="overflow-hidden rounded-3xl bg-slate-900 shadow-sm ring-1 ring-slate-200">
                <YouTubeEmbed
                  videoId="hiphswL-Mh0"
                  title="Urinary incontinence study — The Urology Place"
                />
              </div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="relative aspect-square overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
              <Image
                ...
                alt="Mobile app experience for the Revi urinary incontinence study system"
                fill
          ...
          <div className="mt-10 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200 md:p-8">
            <div
              ...
              role="tablist"
              aria-label="Urinary incontinence study information"
            >
              {TABS.map((tab) => (
                <button
                  key={tab.id}
                  ...
                  aria-controls={`ui-study-panel-${tab.id}`}
                  id={`ui-study-tab-${tab.id}`}
            ...
            <div
              id={`ui-study-panel-${active.id}`}
              role="tabpanel"
              aria-labelledby={`ui-study-tab-${active.id}`}
